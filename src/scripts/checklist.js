...
// This started out as a script to meant to enable persistent
// checklists, allowing students to track their progress.
//
// Then I added the feature of automatically generating a checklist
// from the assigned exercises on a page. For this feature, create
// an empty div with the class 'auto-tally':
//
// :::auto-tally
// :::
//
// Then I added a bunch of other features, most of which I no longer use.
//
  ...
  $('.exercise').each(function () {
    ...
    if (typeof v !== 'undefined' && v != "none" && v != 'saveRule') {
      ...
      if (addcheckboxestoexercises) {
        ...
        // exercise has an explicit point value set, then it will display 
        // that point value in a second child span.
